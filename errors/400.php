  ...
  <body>
    <div class="container">
      <div class="centralizar">
        <h1 class="errorConexao"><img class="icone" src="/sgm/errors/img/warning-icon.svg" alt="Ícone de alerta"> Requisição inválida !</h1>
        <img style="width: 20rem;" src="/sgm/errors/img/erro400.svg">
      </div>
    </div>
