  ...
  <body>
    <div class="container">
      <div class="centralizar">
        <h1 class="errorConexao"><img class="icone" src="/sgm/errors/img/warning-icon.svg" alt="Ícone de alerta"> Erro interno do servidor !</h1>
        <img style="width: 20rem;" src="/sgm/errors/img/erro500.svg">
      </div>
    </div>
