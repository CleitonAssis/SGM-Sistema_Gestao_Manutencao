  ...
  <body>
    <div class="container">
      <div class="centralizar">
        <h1 class="errorConexao"><img class="icone" src="/sgm/errors/img/warning-icon.svg" alt="Ícone de alerta"> Acesso proibido !</h1>
        <img style="width: 20rem;" src="/sgm/errors/img/erro403.svg">
      </div>
    </div>
