  ...
  <body>
    <div class="container">
      <div class="centralizar">
        <h1 class="errorConexao"><img class="icone" src="/sgm/errors/img/warning-icon.svg" alt="Ícone de alerta"> Não autorizado !</h1>
        <img style="width: 20rem;" src="/sgm/errors/img/erro401.svg">
      </div>
    </div>
